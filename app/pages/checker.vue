        ...
        <v-dialog v-model="dialog" max-width="400px">
            ...
            <v-card class="profile-card" elevation="1">
                <div style="margin-left: 1rem;">
                    ...
                    <div class="text-body">
                        <b>ผลกิจกรรม</b><br>
                        <span v-if="attendancePercentage >= 60" style="color: green; font-weight: bold;">
                            ผ่าน
                        </span>
                        <span v-else style="color: darkred; font-weight: bold;">
                            ไม่ผ่าน
                        </span>
                        <span style="color: #676767; font-style: italic;">- คิดเป็น {{ attendancePercentage.toFixed(2) }}% จากทั้งหมด {{ totalDays }} วัน</span><br>
                    </div>
                </div>
            </v-card>
...
const goCheck = () => {
    localStorage.setItem('previousPage', "/checker")
